...
class JointImpedanceExampleController : public controller_interface::MultiInterfaceController<
 ...
 private:
  ...
  double radius_{0.0}; //used to be 0.1
  ...
  std::array<double, 16> initial_previous_pose_;
  ...
  // added by Camille
  ros::Time initial_time_; //modified, added the init time to have access to it in update function to save/print the time starting at 0
};
